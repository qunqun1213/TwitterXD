...
public class AllAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AllAdapter(List<Info> m){
        this.mtList = m;
    }
    private Context mContext;
    private Activity activity;
    public AllAdapter(List<Info> info, Context mContext){
        this.mtList = info;
        ...
        switch (info.getType()){
            ...
            case TYPE_3:
               ...
               // builder3.append("/sdcard/").append(info.get_imghead());
                File file3 = new File(mtList.get(position).get_imghead());
                if(!file3.exists())
                    h3._headimage.setImageResource(R.drawable.dft);
                else
                    h3._headimage.setImageURI(Uri.parse(mtList.get(position).get_imghead()));
            ...
            default:
               ...
               // builder1.append("/sdcard/").append(info.get_imghead());
                File file1 = new File(mtList.get(position).get_imghead());
                if(!file1.exists())
                    h1._headimage.setImageResource(R.drawable.dft);
                else
                    h1._headimage.setImageURI(Uri.parse(mtList.get(position).get_imghead()));
