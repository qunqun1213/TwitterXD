...
public class fAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    //不转发
    ...
    public fAdapter(List<Info> m){
        this.mtList = m;
    }
    private Context mContext;
    public fAdapter(List<Info> infos, Context mContext){
        this.mtList = infos;
        this.mContext = mContext;
        this.activity = (searchActivity)mContext;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (info.getType()){
            case TYPE_1:
                ...
                h._headimage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(),Other_Homepage.class);
                        intent.putExtra("userId",info.get_idnumber());
                        intent.putExtra("_name",info.get_name());
                        intent.putExtra("_imghead",info.get_imghead());
                        intent.putExtra("fan",info.getFan());
                        intent.putExtra("follow",info.getFollow());
            ...
            case TYPE_3:
                ...
                h3._headimage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(),Other_Homepage.class);
                        intent.putExtra("userId",info.get_idnumber());
            ...
            default:
                ...
                h1._headimage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(),Other_Homepage.class);
                        intent.putExtra("userId",info.get_idnumber());
